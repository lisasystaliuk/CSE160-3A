...
class Vector3 {
    ...
    add(other) {
        ...
        for (i = 0; i < 3; ++i) { // for each dimension
          this.elements[i] += other.elements[i]; // add the two values
        }
    ...
    sub(other) {
        ...
        var i;
        for (i = 0; i < 3; ++i) { // for each dimension
          this.elements[i] -= other.elements[i]; // subtract the other from current.
        }
        // This function should change this vector (this.elements) and not create a new vector.
    ...
    div(scalar) {
        ...
        if (scalar !== 0) {
          var i;
          for (i = 0; i < 3; ++i) { // for each of the dimensions
              this.elements[i] /= scalar; // divide by the scalar
          }
        }
        // This function should change this vector (this.elements) and not create a new vector.
    ...
    static dot(other1, other2) {
        ...
        var i;
        for (i = 0; i < 3; ++i) { // for each dimension
          d += other1.elements[i] * other2.elements[i]; // multiply the two values and add it to d
        }
        // Don't delete the return statement.
        return d;
    }
    ...
    normalize() {
        ...
        if (m !== 0) { // this will not work with a magnitude of 0
        
          var i;
          for (i = 0; i < 3; ++i) { // for each dimension
            this.elements[i] /= m; // divide each dimension by the magnitude
        }
    }
        // This function should change this vector (this.elements) and not create a new vector.
